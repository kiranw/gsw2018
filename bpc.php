            ...
            <div class="row header-row">
                ...
                <div class="col-md-9 marginTop">
                    ...
                    <p class="competition-slogan">Are you an entrepreneur trying to take your startup to the next level?<br>
                        ...
                        <br>
                        <br>
                        <span class="competition-rules">For additional detail on format and eligibility requirements, <a href="Rules.pdf"><strong>please read the BPC Rules here</strong></a> before applying.</span>
                    </p>
                </div>
            </div>
            <div class="row">
